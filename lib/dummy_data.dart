...
class UDummyData {
  ...
  static final List<BrandModel> brands = [
    ...
    BrandModel(id: '4', image: UImages.bataLogo, name: 'Bata', productsCount: 1, isFeatured: true),
    BrandModel(id: '5', image: UImages.bloodyLogo, name: 'Bloody', productsCount: 4, isFeatured: false),
    BrandModel(id: '6', image: UImages.breakoutLogo, name: 'Breakout', productsCount: 3, isFeatured: true),
    BrandModel(id: '7', image: UImages.dariMoochLogo, name: 'Dari Mooch', productsCount: 3, isFeatured: true),
    BrandModel(id: '8', image: UImages.interWoodLogo, name: 'Interwood', productsCount: 5, isFeatured: false),
    BrandModel(id: '9', image: UImages.hpLogo, name: 'HP', productsCount: 7, isFeatured: false),
    BrandModel(id: '10', image: UImages.jLogo, name: 'J.', productsCount: 2, isFeatured: true),
    BrandModel(id: '11', image: UImages.nDURELogo, name: 'NDURE', productsCount: 2, isFeatured: true),
    BrandModel(id: '12', image: UImages.northStarLogo, name: 'NorthStar', productsCount: 2, isFeatured: true),
    BrandModel(id: '13', image: UImages.poloLogo, name: 'Polo', productsCount: 2, isFeatured: true),
  ];
